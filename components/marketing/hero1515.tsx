    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <div
          ...
          style={{ color: "#e8a090" }}
        >
          <span className="inline-block size-2 rounded-full" style={{ background: "#e04e28" }} aria-hidden />
          {c.hero.kickerLine}
        </div>
        ...
        >
          {c.hero.headlineLead}
          <br />
          <span style={{ color: "#e04e28" }}>{c.hero.headlineAccentLine1}</span>
          <br />
          {c.hero.headlineTail}
        </h1>
        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm" style={{ color: "rgba(255,255,255,0.50)" }}>
          <div className="flex items-center gap-1.5">
            <MapPin className="size-3.5 shrink-0" style={{ color: "#e04e28" }} aria-hidden />
            <a
